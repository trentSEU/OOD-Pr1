...
DbCore<PayLoad> makePackageDb()
{
  ...
  elem.addChildKey("Persist");elem.addChildKey("Query");
  elem.addChildKey("TestClass");elem.addChildKey("StringUtilities");
  db.addRecord("Exec", elem);
  elem = makeElement<PayLoad>("DbCore", "base db functionality");elem.clearChildKeys();
  elem.addChildKey("DateTime");elem.addChildKey("PayLoad");
  elem.addChildKey("StringUtilities");
  db.addRecord("DbCore", elem);
  elem = makeElement<PayLoad>("Edit", "edit db elements");elem.clearChildKeys();
  elem.addChildKey("DateTime");elem.addChildKey("DbCore");
  elem.addChildKey("PayLoad");elem.addChildKey("Query");
  elem.addChildKey("StringUtilities");
  db.addRecord("Edit", elem);
  elem = makeElement<PayLoad>("PayLoad", "application specific data");
  elem.clearChildKeys();elem.addChildKey("DbCore");
  elem.addChildKey("StringUtilities");
  ...
  elem.addChildKey("DateTime");elem.addChildKey("DbCore");
  elem.addChildKey("PayLoad");elem.addChildKey("Query");
  elem.addChildKey("StringUtilities");elem.addChildKey("XmlDocument");
  elem.addChildKey("XmlElement");
  db.addRecord("Persist", elem);
  elem = makeElement<PayLoad>("Query", "search for db information");
  elem.clearChildKeys();
  elem.addChildKey("DbCore");elem.addChildKey("PayLoad");
  elem.addChildKey("StringUtilities");
